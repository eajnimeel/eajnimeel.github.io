...
개발자 방송이나 블로그등을 보면 맥 사용하는 유저가 `brew install java` 같은 형식으로 프로그램을 설치하는 것을 본 경험이 있을 것임. 이와 비슷한 짓을 윈도우에서 하게 하는 것이 scoop (https://scoop.sh/)
...
## powershell 좀 이쁘게
### Hyper
Hyper(https://hyper.is/) 라는 터미널 프로그램 설치
